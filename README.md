...
The latest version of the library is 9.5 (the version number of this library matches the version of `kjson` with which
...
### Gradle
```groovy
    implementation 'io.kjson:kjson-spring3:9.5'
```
### Gradle (kts)
```kotlin
    implementation("io.kjson:kjson-spring3:9.5")
