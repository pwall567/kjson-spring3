...
The latest version of the library is 4.4.2 (the version number of this library matches the version of `kjson` with which
...
### Gradle
```groovy
    implementation 'io.kjson:kjson-spring3:4.4.2'
```
### Gradle (kts)
```kotlin
    implementation("io.kjson:kjson-spring3:4.4.2")
